...
require_once("../../models/mdlRol.php");
 $rol = new mdlRol();
 $datos = $rol->mdlValidarAcceso_rol($_SESSION["token"],"Servicios");
...
<head>
    <title>Taller mecanico | Servicio</title>
...
<body>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Mantenimiento Servicio</a></li>
    ...
    <script type="text/javascript" src="mntservicio.js"></script>
</body>
