            ...
            <form method="post" id="mantenimiento_form">
                <div class="modal-body">
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                <label for="valueInput" class="form-label">Nombre Servicio</label>
                                <input type="text" class="form-control" id="servicio" name="servicio" required />
                                <span class="text-danger" id="serviciohelp"> </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                <label for="valueInput" class="form-label">Costo</label>
                                <input type="number" class="form-control" id="costo" name="costo" required />
                                <span class="text-danger" id="costohelp"> </span>
                            </div>
                        </div>
                    </div>
