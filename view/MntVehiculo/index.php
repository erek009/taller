...
require_once("../../models/mdlRol.php");
 $rol = new mdlRol();
 $datos = $rol->mdlValidarAcceso_rol($_SESSION["token"],"Vehiculo");
...
<head>
    <title>Taller mecanico | Vehiculo</title>
...
<body>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Mantenimiento Vehiculo</a></li>
    ...
    <script type="text/javascript" src="mntvehiculo.js"></script>
</body>
