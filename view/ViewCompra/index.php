                                                ...
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-lg-3 col-6">
                                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Numero de Compra</p>
                                                ...
                                                <div class="card-body p-4 border-top border-top-dashed">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-medium mb-2" id="prov_id"></p>
                                                            <p class="fw-medium mb-2" id="prov_rfc"></p>
                                                            <p class="fw-medium mb-2" id="prov_direccion"></p>
                                                    ...
                                                    <div class="border-top border-top-dashed mt-2">
                                                        ...
                                                        <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Sub Total</td>
                                                                    <td class="text-end" id="compra_subtotal"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>IGV (18%)</td>
                                                                ...
                                                                <tr class="border-top border-top-dashed fs-15">
                                                                    ...
                                                                    <th class="text-end" id="compra_total"></th>
                                                                </tr>
                                                            </tbody>
                                                        </table>
