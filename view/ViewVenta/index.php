...
$rol = new mdlRol();
$datos = $rol->mdlValidarAcceso_rol($_SESSION["token"], "Lista venta");
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="mt-sm-5 mt-4">
                                                                ...
                                                                <p class="text-muted mb-1" id="txtdireccion"> 8 sur</p>
                                                            </div>
                                                        </div>
                                                        <div class="flex-shrink-0 mt-sm-0 mt-3">
                                                            <h6><span class="text-muted fw-normal">RFC: Sin RFC </span><span id="txtrfc"></span></h6>
                                                            <h6><span class="text-muted fw-normal">Email: eric@refacciones.com </span><span id="txtemail"></span></h6>
                                                            <h6><span class="text-muted fw-normal">Pagina Web: sin pagina</span> <a href="https://themesbrand.com/" class="link-primary" target="_blank" id="txtweb"></a></h6>
                                                            <h6 class="mb-0"><span class="text-muted fw-normal">Telefono: 222000000</span><span id="txttel"></span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-lg-3 col-6">
                                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Numero de Venta</p>
                                                ...
                                                <div class="card-body p-4 border-top border-top-dashed">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-medium mb-2" id="clie_id"></p>
                                                            <p class="fw-medium mb-2" id="clie_direccion"></p>
                                                            <p class="fw-medium mb-2" id="clie_telefono"></p>
                                                        </div>
                                                    ...
                                                    <div class="border-top border-top-dashed mt-2">
                                                        ...
                                                        <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Sub Total</td>
                                                                    <td class="text-end" id="venta_subtotal"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>IGV (18%)</td>
                                                                    <td class="text-end" id="venta_iva"></td>
                                                                </tr>
                                                                <tr class="border-top border-top-dashed fs-15">
                                                                    <th scope="row">Total</th>
                                                                    <th class="text-end" id="venta_total"></th>
                                                                </tr>
                                                            </tbody>
                                                        </table>
