...
$rol = new mdlRol();
$datos = $rol->mdlValidarAcceso_rol($_SESSION["token"], "ordenes");
...
?>
        ...
        <head>
            <title>Taller mecanico | Orden</title>
                                    ...
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Mantenimiento Orden</a></li>
