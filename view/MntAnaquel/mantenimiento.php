                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="anaquel" name="anaquel" placeholder="Ejemplo A-B-C" required />
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ejemplo Zona A: Motor" required />
