...
?>
        ...
        <head>
            <title>Taller mecanico | Anaquel</title>
        ...
        <body>
                                    ...
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Mantenimiento Anaquel</a></li>
                                                <li class="breadcrumb-item active">Anaquel</li>
                                            </ol>
                                        </div>
            ...
            <script type="text/javascript" src="mntanaquel.js"></script>
        </body>
